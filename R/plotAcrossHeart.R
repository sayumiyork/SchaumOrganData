#' plotAcrossHeart
#'
#' Creates a figure plotting the gene expression using filtered TD-data from the Schaum et al. (2020) heart dataset across samples from both sexes of mice over time
#'
#'
#' @param x A string containing a valid Mouse Genome Informatics (MGI) ID that is found in the dataset
#' @return A figure plotting the gene expression of filtered TD-data from the Schaum et al. (2020) heart dataset across samples from both sexes of mice over time
#' @export


plotAcrossAgeHeart<- function( x ) {
